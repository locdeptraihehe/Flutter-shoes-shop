...
class NotificationRepoImpl with NotificationRepo {
  ...
  Future<bool> newProductNotification({required String token}) async {
    ...
    dio.options.headers["authorization"] = "key=${Constants.fcmAccessToken}";
    ...
    try {
      final response =
        ...
        "notification": {
          "body": "Có sản phầm mới vừa được thêm.",
          "title": "Sản phẩm mới",
          "sound": true
        },
  ...
  Future<bool> newOrderNotification({required String token}) async {
    ...
    try {
      final response =
        ...
        "registration_ids": [token],
        "notification": {
          "body": "Khách hàng vừa lên đơn mới.",
          "title": "Đơn hàng mới",
          "sound": true
        },
        "data": {"content_type": "notification", "value": 2},
  ...
  Future<bool> newPostNotification({required String token}) async {
    ...
    try {
      final response =
        ...
        "registration_ids": [token],
        "notification": {
          "body": "Có bài viết mới vừa được thêm.",
          "title": "Bài viết mới",
          "sound": true
        },
        "data": {"content_type": "notification", "value": 2},
